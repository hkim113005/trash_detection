...
class CocoFilter():
    ...
    def main(self, input_json_dir, categories):
        # Open json
        self.input_json_path = Path(input_json_dir + "instances_default.json")
        self.output_json_path = Path(input_json_dir + "instances_filtered.json")
